...
def create(service, user, email):
    ...
    """
    Check the date if is passed and kick and ask
    """
    ...
    if my_date < datetime.datetime.now():
        ...
        event=do_create(service,Summary,Descript,startD,startT,endT,user,email,confirm)
...
def do_create(service,Summary,Descript,startD,startT,endT,username,email,confirm):
